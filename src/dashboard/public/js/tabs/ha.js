...
export async function loadHaMappings() {
...
export async function fetchHaEntities() {
    const haDiscoverySection = document.getElementById('ha-entities-container');
...
export function setupHa() {
    const fetchHaEntitiesBtn = document.getElementById('fetch-ha-entities-btn');
    const haEntitiesFilter = document.getElementById('ha-entity-filter');
    ...
    if (addHaMappingBtn) addHaMappingBtn.addEventListener('click', () => showHaMappingForm());
    if (haMappingCancelBtn) haMappingCancelBtn.addEventListener('click', hideHaMappingForm);
    if (haMappingSaveBtn) haMappingSaveBtn.addEventListener('click', saveHaMapping);
